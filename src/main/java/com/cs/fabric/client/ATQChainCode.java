...
public class ATQChainCode {
	...
	private static final Log logger = LogFactory.getLog(ATQChainCode.class);
	private String[] args;
	private HFClient client;
	private Channel channel;
	private ChaincodeID chaincodeID;

	public ATQChainCode(String[] args) throws CryptoException, InvalidArgumentException, NoSuchAlgorithmException,
	...
	public void invoke() throws InvalidArgumentException, ProposalException, InvalidProtocolBufferException,
		...
		transactionProposalRequest.setArgs(argsOnly);
