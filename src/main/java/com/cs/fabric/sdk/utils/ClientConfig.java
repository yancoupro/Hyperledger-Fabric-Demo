...
public class ClientConfig {
    ...
    private ClientConfig() {
        ...
        //////
        defaultProperty(INTEGRATIONTESTS_ORG + "peerOrgAtq.mspid", "OrgAtqMSP");
        defaultProperty(INTEGRATIONTESTS_ORG + "peerOrgAtq.domname", "peer0.atq.example.com");
        //defaultProperty(INTEGRATIONTESTS_ORG + "peerOrgAtq.ca_location", "http://localhost:7054");
        defaultProperty(INTEGRATIONTESTS_ORG + "peerOrgAtq.ca_location", "http://admin:adminpw@localhost:7054");
        defaultProperty(INTEGRATIONTESTS_ORG + "peerOrgAtq.peer_locations",
                "peer0.atq.example.com@grpc://localhost:7051, peer1.atq.example.com@grpc://localhost:7053");
        defaultProperty(INTEGRATIONTESTS_ORG + "peerOrgAtq.orderer_locations",
                "orderer.example.com@grpc://localhost:7050");
        defaultProperty(INTEGRATIONTESTS_ORG + "peerOrgAtq.eventhub_locations",
                "peer0.atq.example.com@grpc://localhost:7051,peer1.atq.example.com@grpc://localhost:7053");


        defaultProperty(INTEGRATIONTESTS_ORG + "peer0OrgAbattoir.mspid", "OrgAbattoirMSP");
        defaultProperty(INTEGRATIONTESTS_ORG + "peer0OrgAbattoir.domname", "peer0.abattoir.example.com");
        defaultProperty(INTEGRATIONTESTS_ORG + "peer0OrgAbattoir.ca_location", "http://admin:adminpw@localhost:7054");
        defaultProperty(INTEGRATIONTESTS_ORG + "peer0OrgAbattoir.peer_locations",
                "peer0.abattoir.example.com@grpc://localhost:7051, peer0.abattoir.example.com@grpc://localhost:7053");
        defaultProperty(INTEGRATIONTESTS_ORG + "peer0OrgAbattoir.orderer_locations",
                "orderer.example.com@grpc://localhost:7050");
        defaultProperty(INTEGRATIONTESTS_ORG + "peer0OrgAbattoir.eventhub_locations",
                "peer0.abattoir.example.com@grpc://localhost:7051,peer0.abattoir.example.com@grpc://localhost:7053");
        ...
        for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
            ...
            System.out.println("k vs name: "+ org.getKey() + " / " + orgName);
